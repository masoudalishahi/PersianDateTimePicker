...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        @SuppressLint("PrivateResource") int backgroundColor = a.getColor(R.styleable.MaterialCalendar_backgroundTint, 0);
    ...
    public View onCreateView(
        ...
        int layout = fullscreen ? R.layout.picker_fullscreen : R.layout.picker_dialog;
    ...
    private void startPickerFragment() {
        ...
        pickerFragment.addOnSelectionChangedListener(
                new OnSelectionChangedListener<>() {
                    @Override
                    public void onSelectionChanged(@NonNull S selection) {
                        updateHeader(getHeaderText());
                        confirmButton.setEnabled(getDateSelector().isSelectionComplete());
                    }
    ...
    private void updateToggleContentDescription(@SuppressLint("RestrictedApi") @NonNull CheckableImageButton toggle) {
    ...
    private DateSelector<S> getDateSelector() {
        if (dateSelector == null && getArguments()!=null) {
    ...
    static boolean readMaterialCalendarStyleBoolean(@NonNull Context context, int attributeResId) {
        @SuppressLint("RestrictedApi") int calendarStyle =
    ...
    public static final class Builder<S> {
        ...
        @NonNull
        public Builder<S> setEnableHoliday(Boolean enableHoliday) {
            if (enableHoliday)
                this.dayViewDecorator = new HolidayDecorator();
            return this;
        }
